...
int main(){
    ...
    //Gera a conta de densidade populacional primeira carta - quociente entre populacao e area
    den_pop1 = populacao1 / area_km1;
    
    //Gera a conta de renda per capita primeira carta - quociente entre pib e populacao
